...
export default function Navbar({ dark }) {
  ...
  return (
    <>
      <nav className={` ${dark ? 'bg-[#313131]' : 'bg-[#E1F5F0]'} h-24 fixed w-full z-80 top-0 start-0`}>
        <div className={`mx-4 my-2 h-20 ${dark ? 'bg-[#171717]' : 'bg-[#f5f5f5] shadow-xl'} rounded-xl flex items-center justify-between p-4`}>
          ...
          <div className={`relative`}>
            <input type="text" className={`block max-sm:w-40 w-full p-2 pl-10 text-xs  ${dark?'placeholder-[#171717] bg-[#7FFF9B] ':'placeholder-[#e9e9e9] bg-[#235347]'} rounded-lg bg-[#7FFF9B]`} placeholder="Search..." />
